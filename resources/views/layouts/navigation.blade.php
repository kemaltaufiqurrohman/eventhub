                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                   ...
                   <nav x-data="{ open: false }" class="bg-white border-b border-gray-200 shadow-sm">
                            ...
                            <div class="flex justify-between h-16">
                                ...
                                <div class="-mr-2 flex items-center sm:hidden">
                                    <button @click="open = !open"
                                            class="p-2 rounded-md text-gray-600 hover:text-indigo-600">
                    ...
                    @if(auth()->user()->role === 'panitia')
                        <x-nav-link :href="route('panitia.dashboard')" :active="request()->routeIs('panitia.dashboard')">
                            Dashboard
                        </x-nav-link>

                        <x-nav-link :href="route('panitia.events.create')" :active="request()->routeIs('events.create')">
                            + Tambah Event
                        </x-nav-link>

                        <x-nav-link href="{{ url('/panitia/dashboard') }}#event-list">
                            List Event
                        </x-nav-link>
                    @endif
                    ...
                    @if(auth()->user()->role === 'mahasiswa')
                        ...
                        <x-nav-link :href="route('mahasiswa.events.index')" :active="request()->routeIs('mahasiswa.events.index')">
                            Event Saya
                        </x-nav-link>
                    @endif
